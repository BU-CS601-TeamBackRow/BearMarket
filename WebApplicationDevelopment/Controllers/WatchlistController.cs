...
namespace WebApplicationDevelopment.Controllers
{
    public class WatchlistController : ApiController
    {
        [Route("api/watchlist")]
        [HttpPost]
        public HttpResponseMessage addStockToWatchlist()
        {
            try
            {
                ...
                string queryString =
                    "INSERT INTO dbo.watchlist Output inserted.Id "
                        + " VALUES(NEWID(), @userId, @symbol);";
        ...
        public IHttpActionResult deleteStockFromPortfolio()
        {
            try
            {
                ...
                // Provide the query string with a parameter placeholder. 
                string queryString =
                    "DELETE FROM dbo.watchlist WHERE Id = @Id;";
